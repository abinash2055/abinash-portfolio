...
const ProjectCard = ({
  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      <Tilt
        options={isMobile ? { max: 0, scale: 1 } : { max: 45, scale: 1, speed: 450 }}
        className="bg-tertiary p-5 rounded-2xl w-full sm:w-[360px] min-w-[250px]"
      >
    ...
    <>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          repositories and live demos. They demonstrate my ability to solve
